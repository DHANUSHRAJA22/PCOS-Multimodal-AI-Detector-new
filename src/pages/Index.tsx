...
export function IndexPage() {
    ...
    toast.error(
      <div className="space-y-2">
        ...
        <div className="text-sm space-y-1">
          ...
          {isInSandbox && (
            <div className="text-orange-600">Running in sandbox - local proxy unavailable</div>
          )}
        </div>
      </div>,
      { duration: 8000 }
  ...
  const handleSampleSelect = (type: 'face' | 'xray', processedImage: ProcessedImage) => {
    if (type === 'face') setFaceImage(processedImage)
    else setXrayImage(processedImage)
  }
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (faceImage) formData.append('face_img', faceImage.file)
      if (xrayImage) formData.append('xray_img', xrayImage.file)
          ...
          <div className="max-w-4xl mx-auto text-center py-12">
            ...
            <Reveal delay={0.1}>
              <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
                <span className="text-[#1E293B]">Multimodal PCOS</span><br />
            ...
            <Card className="shadow-vibrant-lg border-0 card-gradient backdrop-blur-sm">
              <CardHeader className="text-center pb-6">
                ...
                <CardDescription className="text-lg max-w-2xl mx-auto text-slate-600">
                  Upload a facial photo and/or uterus X-ray for comprehensive PCOS analysis. You can upload one or both images.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <UploadArea
                    ...
                    value={faceImage}              // <-- pass selected sample here
                  ...
                  <UploadArea
                    ...
                    value={xrayImage}              // <-- pass selected sample here
                ...
                <div className="text-center space-y-4">
                  ...
                  {!hasImages && <p className="text-sm text-muted-foreground">Please upload at least one image to proceed</p>}
                  {backendStatus !== 'online' && hasImages && (
                    <p className="text-sm text-amber-600 font-medium">Backend must be online to analyze images</p>
                  )}
                </div>

                <MedicalDisclaimer />

                {/* Samples — tapping a tile injects into the correct UploadArea */}
          ...
          <Reveal>
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-slate-600">Everything you need to know about our PCOS screening tool</p>
              </div>
